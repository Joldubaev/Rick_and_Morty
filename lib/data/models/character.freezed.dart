...
class _$_Character implements _Character {
  const _$_Character({required this.info, required final List<Result> results})
      : _results = results;
...
abstract class _Character implements Character {
  const factory _Character(
      ...
      required final List<Result> results}) = _$_Character;
...
abstract class _Result implements Result {
  const factory _Result(
      ...
      required final String image}) = _$_Result;
